...
<head>
  ...
  <title>Perfil | Plataforma ITSM</title>
...
<div class="form-container">
  ...
  <form action="atualiza_registro.php" method="post">
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="username" name="username" value="<?php echo htmlspecialchars($_SESSION['usuario_login']); ?>" readonly required>
    </div>
    <div class="mb-3">
      <label for="nome" class="form-label">Nome Completo</label>
      <input type="text" class="form-control" id="nome" name="nome" value="<?php echo htmlspecialchars($_SESSION['usuario_nome']); ?>" required>
    </div>
    <div class="mb-3">
      <label for="email" class="form-label">E-mail</label>
      <input type="email" class="form-control" id="email" name="email" value="<?php echo htmlspecialchars($_SESSION['usuario_email']); ?>" required>
    </div>
    <div class="d-flex justify-content-center gap-3 mt-4">
      <button type="button" class="btn btn-outline-secondary" onclick="history.back();">Voltar</button>
      <button type="button" class="btn btn-secondary" onclick="window.location.href='/ITSM/formulario/form_altera_senha.php'">Alterar Senha</button>
      <button type="submit" class="btn btn-dark" id="btnAtualizar" disabled>Atualizar</button>
    </div>
  </form>
</div>
</main>
