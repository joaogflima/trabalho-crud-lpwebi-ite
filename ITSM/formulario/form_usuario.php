...
<head>
  ...
  <title>Usuário | Plataforma ITSM</title>
...
<main>
  <div class="form-container">
    ...
    <form action="atualiza_registro.php" method="post">
      <input type="hidden" name="id" value="<?php echo htmlspecialchars($id); ?>">
      <div class="mb-3">
        <label for="login" class="form-label">Usuário (login)</label>
        <input type="text" class="form-control" id="username" name="username" value="<?php echo htmlspecialchars($usuario['login']); ?>" required>
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <select class="form-select" id="funcao" name="funcao" required>
          <option value="Solicitante" <?php echo $usuario['funcao'] == 'Solicitante' ? 'selected' : ''; ?>>Solicitante</option>
          <option value="Atendente" <?php echo $usuario['funcao'] == 'Atendente' ? 'selected' : ''; ?>>Atendente</option>
      ...
      <div class="mb-3">
        ...
        <select class="form-select" id="ativo" name="ativo" required>
          <option value="1" <?php echo $usuario['ativo'] == 1 ? 'selected' : ''; ?>>Verdadeiro</option>
          <option value="0" <?php echo $usuario['ativo'] == 0 ? 'selected' : ''; ?>>Falso</option>
        </select>
      </div>
      <div class="d-flex justify-content-center gap-3 mt-4">
        <a href="/ITSM/lista/usuarios.php" class="btn btn-outline-secondary">Voltar</a>
        <a href="/ITSM/formulario/form_altera_senha.php?id=<?php echo $id; ?>" class="btn btn-secondary">Alterar Senha</a>
...
<script>
    ...
    function verificarAlteracoes() {
        ...
        if (nomeAtual !== nomeOriginal || emailAtual !== emailOriginal) {
    ...
    nomeInput.addEventListener('input', verificarAlteracoes);
