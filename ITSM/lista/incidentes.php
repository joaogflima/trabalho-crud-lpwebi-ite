...
WHERE incidentes.codigo LIKE '%$pesquisa%' 
   OR incidentes.titulo LIKE '%$pesquisa%' 
   OR incidentes.descricao LIKE '%$pesquisa%'
";
...
foreach ($resultado as $linha) {
    ...
    $corPrioridade = match ($linha['prioridade']) {
        'Baixa' => 'success',
        'Média' => 'warning',
        'Alta' => 'danger',
        default => 'dark'
    ...
    echo "
    <tr>
        <td><a href='/ITSM/formulario/form_incidente.php?codigo=" . $linha['codigo'] . "' class='link-dark' title='Abrir incidente'>" . $linha['codigo'] . "</a></td>
        <td>" . $linha['titulo'] . "</td>
        <td><span class='badge bg-{$corPrioridade}'>" . $linha['prioridade'] . "</span></td>
        ...
        <td>
            <a href='/ITSM/formulario/form_incidente.php?codigo=" . $linha['codigo'] . "' class='btn btn-sm btn-outline-primary'>
